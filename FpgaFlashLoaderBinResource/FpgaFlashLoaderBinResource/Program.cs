...
namespace FpgaFlashLoader
{
    public class Program
    {
        ...
        public static void UploadImage(SPI spi, int address, PageUploadedDelegate pageUploadedDelegate)
        {
...
//               bytesRemaining=
                int i;
                if (bytesRead < SramPageBufferSize)
                    for (i = bytesRead; i < SramPageBufferSize; i++)
                        readBuffer[i + 4] = 0xFF;
